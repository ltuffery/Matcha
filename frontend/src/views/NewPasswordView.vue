  ...
  <main v-else class="grid grid-cols-1 place-content-center h-dvh place-items-center bg-base-200 px-2">
    <div class="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
        <div class="card-body">
            ...
            <span v-if="pageState == 'badToken'" class="text-error">You don't have right to change this password or your link has expired</span>
            
            <!-- ### Body confirmation of updating password  ### -->
            <span v-if="pageState == 'updatePwdSuccess'" class="text-success">Your password has been successfully changed !</span>
        </div>
    </div>
  </main>
</template>
