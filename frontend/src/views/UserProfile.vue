...
<template>
  <div class="flex bg-base-300 h-dvh w-full justify-center items-center">
    <div class="overflow-y-auto relative bg-base-200 h-full w-full max-w-3xl">
      ...
      <button v-if="data?.me" class="sticky bottom-[5%] left-full mr-10 z-30 rounded-full btn btn-outline bg-base-300/80 flex items-center justify-center size-14">
        <svg class="w-11" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
