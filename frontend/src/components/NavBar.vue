...
<template>
  <header v-if="sizeScreen.matches" class="z-50 fixed left-0 h-full w-24 bg-base-200">
    <div class="flex flex-col h-full justify-between items-center">
      <div class="flex flex-col items-center gap-3 pt-5 w-full">
        ...
        <div class="tooltip tooltip-right" data-tip="Home">
          <button @click="goTo('main')" class="size-16 bg-base-100 rounded-xl btn">
        ...
        <div class="tooltip tooltip-right" data-tip="Search">
          <button @click="goTo('search')" class="size-16 bg-base-100 rounded-xl btn">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <path d="M18.5 18.5L22 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                <path d="M6.75 3.27093C8.14732 2.46262 9.76964 2 11.5 2C16.7467 2 21 6.25329 21 11.5C21 16.7467 16.7467 21 11.5 21C6.25329 21 2 16.7467 2 11.5C2 9.76964 2.46262 8.14732 3.27093 6.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
              </g>
            </svg>
          </button>
        </div>
        ...
        <div class="tooltip tooltip-right" data-tip="Messages">
          <button @click="goTo('chat')" class="size-16 bg-base-100 rounded-xl btn">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                ...
                <path d="M18 8L15.8411 9.79908C14.0045 11.3296 13.0861 12.0949 12 12.0949C11.3507 12.0949 10.7614 11.8214 10 11.2744M6 8L6.9 8.75L7.8 9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
              </g>
            </svg>
          </button>
        </div>
        ...
        <div class="tooltip tooltip-right" data-tip="Likes">
          <button @click="goTo('history')" class="size-16 bg-base-100 rounded-xl btn">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
