    ...
    <div class="card bg-base-300 gap-3 w-full p-5">
      ...
      <div class="flex w-full gap-2">
        <label class="input input-bordered w-full flex items-center gap-2">
          ...
          <input ref="email" v-on:keyup.enter="sendChangement" @blur="sendChangement" id="email" type="text" class="grow" placeholder="Email" value="test@test.test" disabled />
        </label>
    ...
    <div class="card bg-base-300 gap-3 w-full p-5">
      <div class="flex flex-col w-full gap-4">
        ...
        <label>First Name (Display name) :</label>
          <div class="flex w-full gap-2">
            <input ref="firstName" v-on:keyup.enter="sendChangement" @blur="sendChangement" id="fname" type="text" placeholder="First Name" class="input input-bordered w-full" value="tmpName" disabled />
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex w-full gap-2">
            <input ref="lastName" v-on:keyup.enter="sendChangement" @blur="sendChangement" id="lname" type="text" placeholder="First Name" class="input input-bordered w-full" value="tmpName" disabled />
...
<!--        <label>X / 512</label>-->
<!--      </div>-->
<!--      <textarea class="textarea textarea-bordered" style="resize: none" placeholder="Bio"></textarea>-->
<!--    </div>-->
<!--  </div>-->
