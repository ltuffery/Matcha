...
const refs = ref<
  ...
  >
>({})
const step = ref<InstanceType<typeof MultiStepForm>>()
...
const totalSteps = 5
const feedbackRef = ref<InstanceType<typeof FeedbackToast>>()
...
async function handleSubmit() {
  try {
    ...
    for (const name in formData.value) {
      form.append(
        name,
        String(formData.value[name as keyof typeof formData.value]),
      )
    }
    ...
    if (req.status == 400) {
      ...
      Api.post('email/verif').send({ email: formData.value.email })
      step.value?.nextStep()
    }
  } catch (error) {
...
function focusInput(code: number) {
...
function eraseErrorStyle(el: Event) {
  const target = el.target as HTMLElement
  target.classList.remove('input-error')
  target.classList.remove('select-error')
  target.classList.remove('textarea-error')
}
</script>
...
<template>
  ...
  <form @submit.prevent="handleSubmit">
    <MultiStepForm :total-steps="totalSteps" @submit="handleSubmit" ref="step">
      <template #step-0>
        <div class="flex flex-col gap-3">
          <div class="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input
              ...
              :ref="el => (refs.username = el as HTMLInputElement)"
          ...
          <div class="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input
              ...
              :ref="el => (refs.email = el as HTMLInputElement)"
              placeholder="email"
              @input="eraseErrorStyle"
            />
          </div>
          <div class="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Input
              ...
              :ref="el => (refs.password = el as HTMLInputElement)"
        ...
        <form>
          <div class="form-control">
            ...
            <input
              ...
              :ref="el => (refs.first_name = el as HTMLInputElement)"
              type="text"
          ...
          <div class="form-control">
            ...
            <input
              ...
              :ref="el => (refs.last_name = el as HTMLInputElement)"
              type="text"
          ...
          <div class="form-control">
            ...
            <input
              ...
              :ref="el => (refs.birthday = el as HTMLInputElement)"
        ...
        <form>
          <div class="form-control">
            ...
            <select
              ...
              :ref="el => (refs.gender = el as HTMLSelectElement)"
        ...
        <form>
          <div class="form-control">
            ...
            <textarea
              ...
              :ref="el => (refs.biography = el as HTMLTextAreaElement)"
